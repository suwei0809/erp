...
<table border="1px" cellspacing="0" cellpadding="10">
    <tr>
        <td>给简历起个名字：</td>
        <td contentEditable="true" id="nameresume"></td>
    </tr>
    <tr>
        <td height="76px" width="104" >姓名</td>
        <td width="94" height="77" contentEditable="true" id="name"></td>
        <td height="76px" width="104">性别</td>
        <td width="94" height="77"  contentEditable="true" id="sex"></td>
        <td height="76px" width="104">出生年月</td>
        <td width="94" height="77"  contentEditable="true" id="birth"></td>
        <td rowspan="4" width="145" height="315"><input type="file"/></td>
    </tr>
    <tr>
        <td height="76px" width="104">籍贯</td>
        <td  contentEditable="true" id="hometown"></td>
        <td height="76px" width="104">民族</td>
        <td  contentEditable="true" id="nation"></td>
        <td height="76px" width="104">政治面貌</td>
        <td  contentEditable="true" id="polity"></td>
    </tr>
    <tr>
        <td height="76px" width="104">学历</td>
        <td  contentEditable="true" id="education"></td>
        <td height="76px" width="104">身高</td>
        <td  contentEditable="true" id="height"></td>
        <td height="76px" width="104">体重</td>
        <td  contentEditable="true" id="weight"></td>
    </tr>
    <tr>
        <td height="76px" width="104">专业</td>
        <td colspan="3"  contentEditable="true" id="major"></td>
        <td height="76px" width="104">婚否</td>
        <td  contentEditable="true" id="marry"></td>
    </tr>
    <tr>
        <td height="76px" width="104">毕业院校</td>
        <td colspan="3"  contentEditable="true" id="school"></td>
        <td height="76px" width="104">邮箱</td>
        <td colspan=" 3"  contentEditable="true" id="email"></td>
    </tr>
    <tr>
        <td height="76px" width="104">联系电话</td>
        <td colspan="3"  contentEditable="true" id="phone"></td>
        <td height="76px" width="104">现住地址</td>
        <td colspan="3"  contentEditable="true" id="addr"></td>
    </tr>
    <tr>
        <td height="439" width="104">个人履历</td>
        <td colspan="6" valign="top"  contentEditable="true" id="perresume">
        </td>
    </tr>

    <tr>
        <td height="76" width="104">自我评价</td>
        <td colspan="6"  contentEditable="true" id="sel"></td>
    </tr>
</table>
    <div>
